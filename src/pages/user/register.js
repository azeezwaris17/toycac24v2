  ...
  return (
    ...
    >
      <div className="w-full flex flex-col items-center justify-center min-h-screen">
        ...
        <div className="w-full max-w-sm p-4 bg-white rounded-xl text-center">
          <h3 className="text-lg font-bold text-red-500">REGISTRATION CLOSED!!!</h3>
          <p className="mt-2 text-gray-700">
            The registration for TOYCAC&apos;24 has closed, kindly proceed to login if you are already registered.
          </p>
          <button
            className="mt-4 flex items-center justify-center px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600"
